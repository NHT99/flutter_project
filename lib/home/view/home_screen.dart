  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        ...
        Future<void> addNumberDialog() {
          return showDialog<void>(
            ...
            builder: (BuildContext context) {
              return BlocBuilder<HomeBloc, HomeState>(
                builder: (context, state) {
                  //update input controller when state change
                  
                  inputController.text = state.input.toString();
                  return AlertDialog(
        ...
        Future<void> deleleNumber(int index) {
          return showDialog(
            context: context,
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () =>{
                    ...
                    context.read<HomeBloc>().add(DeleteNumberEvent(index))
